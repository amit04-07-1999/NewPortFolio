...
const Footer = () => {
  ...
  return (
    <footer className="relative py-20 px-4 md:px-8 overflow-hidden bg-gray-50">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto relative">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-12">
            <div className="overflow-hidden">
              <div className="animate-slide-down">
                <span className="inline-block text-gray-900">LET'S</span>{' '}
                <span className="inline-block relative">
                  <span className="relative z-10 text-blue-600">
                    BUILD
                  </span>
                </span>{' '}
                <span className="inline-block text-gray-900">SOMETHING</span>
              </div>
            </div>
            <div className="overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-12">
            ...
            <a 
              ...
              className="group relative px-8 py-4 bg-transparent rounded-full inline-flex items-center border border-blue-200 hover:border-blue-500 hover:bg-blue-50 transform transition-all duration-300 hover:scale-105"
            >
          ...
          <div className="flex justify-center space-x-8">
            <a 
              ...
              className="group relative w-14 h-14 rounded-full border border-gray-300 flex items-center justify-center hover:border-blue-500 transition-all duration-300 overflow-hidden transform hover:scale-110"
            >
              <span className="absolute inset-0 bg-blue-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
              <svg className="w-7 h-7 text-gray-600 group-hover:text-blue-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center relative">
          <p className="text-sm text-gray-600 group">
